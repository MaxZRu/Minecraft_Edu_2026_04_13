...
Мы используем цикл `for` — он умеет считать количество повторений.
...
Блок ``||agent:agent place down||`` кладёт блок под ноги агента.

Добавь движение на 5 шагов и размещение блока вниз.
...
Нам нужно нарисовать целую **линию** из 5 блоков, а не один.

Используем ``||loops:repeat 5 times||`` — ставим блок, делаем шаг, ставим блок, делаем шаг...
